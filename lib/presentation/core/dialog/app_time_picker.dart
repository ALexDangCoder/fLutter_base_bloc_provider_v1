...
BorderRadius _kDefaultBorderRadius = BorderRadius.circular(8.r);
ShapeBorder _kDefaultShape =
    ...
    return Container(
      decoration: BoxDecoration(
        border: const Border.fromBorderSide(
          BorderSide(color: ColorsManager.raspberry40),
        ),
...
class _DayPeriodControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle amStyle = TextStyleManager.h1.copyWith(
      color: MaterialStateProperty.resolveAs(textColor, amStates),
      fontWeight: FontWeight.w600,
    );
    final TextStyle pmStyle = TextStyleManager.h1.copyWith(
    ...
    return SizedBox(
      ...
      child: Material(
        ...
        shape: RoundedRectangleBorder(borderRadius: _kDefaultBorderRadius),
        child: Column(
          children: <Widget>[
...
class _DialPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double labelRadius = radius - _labelPadding + 6;
    ...
    const double focusedRadius = _labelPadding / 2;
...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
  ...
  void _selectHour(int hour) {
    ...
    time = widget.mode == _TimePickerMode.hour && widget.use24HourDials
        ? TimeOfDay(hour: hour, minute: widget.selectedTime.minute)
        : widget.selectedTime.period == DayPeriod.am
            ? TimeOfDay(hour: hour, minute: widget.selectedTime.minute)
            : TimeOfDay(
  ...
  List<_TappableLabel> _build24HourRing(Color color) => <_TappableLabel>[
  ...
  List<_TappableLabel> _build12HourRing(Color color) => <_TappableLabel>[
  ...
  List<_TappableLabel> _buildMinutes(Color color) {
    ...
    switch (widget.mode) {
      case _TimePickerMode.hour:
        if (widget.use24HourDials) {
          ...
          primaryLabels = _build24HourRing(primaryLabelColor);
          secondaryLabels = _build24HourRing(secondaryLabelColor);
        } else {
          selectedDialValue = widget.selectedTime.hourOfPeriod;
          primaryLabels = _build12HourRing(primaryLabelColor);
          secondaryLabels = _build12HourRing(secondaryLabelColor);
        }
        break;
      case _TimePickerMode.minute:
        selectedDialValue = widget.selectedTime.minute;
        primaryLabels = _buildMinutes(primaryLabelColor);
        secondaryLabels = _buildMinutes(secondaryLabelColor);
        break;
    }
    ...
    return GestureDetector(
      ...
      child: CustomPaint(
        ...
        painter: _DialPainter(
          ...
          backgroundColor: ColorsManager.plum10,
          accentColor: ColorsManager.raspberry100,
...
class _HourMinuteTextFieldState extends State<_HourMinuteTextField>
  ...
  Widget build(BuildContext context) {
    ...
    inputDecoration = inputDecorationTheme != null
