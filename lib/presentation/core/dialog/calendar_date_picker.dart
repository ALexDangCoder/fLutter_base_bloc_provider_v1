...
///    time picker.
///
class CalendarDatePickers extends StatefulWidget {
  ...
  @override
  State<CalendarDatePickers> createState() => _CalendarDatePickerState();
}

class _CalendarDatePickerState extends State<CalendarDatePickers> {
  ...
  @override
  void didUpdateWidget(CalendarDatePickers oldWidget) {
...
class _DatePickerModeToggleButtonState
  ...
  Widget build(BuildContext context) {
    ...
    const Color controlColor = Colors.black;
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  void _handleGridNextFocus(NextFocusIntent _) {
    _dayGridFocus.requestFocus();
    _dayGridFocus.nextFocus();
  }

  /// Move focus to the previous element before the day grid.
  void _handleGridPreviousFocus(PreviousFocusIntent _) {
    _dayGridFocus.requestFocus();
...
class _DayPickerState extends State<_DayPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    const Color enabledDayColor = Colors.black;
    final Color disabledDayColor = colorScheme.onSurface.withOpacity(0.38);
    final Color selectedDayColor = colorScheme.onPrimary;
    const Color selectedDayBackground = mainColor;
    const Color todayColor = mainColor;
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        if (isSelectedDay) {
          ...
          decoration = const BoxDecoration(
            border: Border.fromBorderSide(BorderSide(color: todayColor)),
            shape: BoxShape.circle,
          );
        }
...
class _YearPickerState extends State<YearPicker> {
  ...
  Widget _buildYearItem(BuildContext context, int index) {
    ...
    yearItem = isDisabled
        ? ExcludeSemantics(child: yearItem)
        : InkWell(
