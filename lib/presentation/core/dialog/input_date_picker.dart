...
///
class InputDatePickerFormFields extends StatefulWidget {
  ...
  @override
  State<InputDatePickerFormFields> createState() =>
      _InputDatePickerFormFieldState();
}

class _InputDatePickerFormFieldState extends State<InputDatePickerFormFields> {
  final TextEditingController _controller = TextEditingController();
  DateTime? _selectedDate;
  String? _inputText;
  bool _autoSelected = false;
  Color divider = const Color(0xFFDADADA);
  ...
  @override
  void didUpdateWidget(InputDatePickerFormFields oldWidget) {
